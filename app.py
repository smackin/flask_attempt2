...
def spell_word(word):
  "Returns word in all caps to be passed into spell route."
...
@app.route('/lucky')
def lucky_number():
  """Returns a randint 1- 10 and displays one int at a time with images"""
  num = randint(1, 10)
...
def add_comment_form():
    return render_template('/add-comment')
